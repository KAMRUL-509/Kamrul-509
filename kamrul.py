...
try:
	prox= requests.get('https://github.com/KAMRUL-509/Kamrul-509/blob/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/KAMRUL-509/Kamrul-509/blob/main/proxies.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/KAMRUL-509/Kamrul-509/blob/main/proxies.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
